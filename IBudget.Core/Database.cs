...
//    /*
//     * 
//     * This class represents hours of my life that I will never get back :D
//     * 
//     */
//    [Obsolete("EntityFrameworkCore is now used, this class is now deprecated")]
...
//                expense.Tags = GetTags(expense.ID);
...
//                UpdateTags(updatedRecord.ID, updatedRecord.Tags);
//            }
//        }
...
//                foreach (var expense in expenses)
//                {
//                    var tags = GetTagObjects(expense.ID);
